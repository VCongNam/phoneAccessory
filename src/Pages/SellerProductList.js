...
const ProductTable = () => {
    ...
    const fetchProducts = async () => {
        ...
        try {
            ...
            // Sắp xếp theo isHot (1: Hot, 0: Không hot), những sản phẩm "Hot" sẽ được đẩy lên đầu
            query = query.order("isHot", { ascending: false });
    ...
    const addProduct = async (values) => {
        try {
            ...
            const newProduct = {
                ...
                isHot: 0, // Mặc định không hot khi thêm mới
            };
    ...
    const columns = [
        ...
        // ------------------ Thêm cột "Hot" ------------------
        {
            ...
            render: (isHot, record) => (
                <Button
                    type={isHot === 1 ? "primary" : "default"}
                    onClick={() => toggleHotStatus(record)}
                >
                    {isHot === 1 ? "Hot" : "Không Hot"}
                </Button>
            ),
        },
        // ---------------------------------------------------
        ...
        <div className="product-table">
            ...
            >
                <Form onFinish={addProduct}>
                    ...
                    <Form.Item
                        name="isHot"
                        label="Trạng thái Hot"
                        initialValue={0} // Mặc định không hot
                    >
                        <Select>
            ...
            {/* Modal Thông Báo Sản Phẩm Sắp Hết Hàng */}
            <Modal
